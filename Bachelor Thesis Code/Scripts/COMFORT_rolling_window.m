...
writematrix(COMFORT_VaR_DCC_sGARCH_mat, 'COMFORT_MVG_DCC_sGARCH_VaR.csv')
writematrix(COMFORT_CVaR_DCC_sGARCH_mat, 'COMFORT_MVG_DCC_sGARCH_CVaR.csv')
...
writematrix(COMFORT_VaR_DCC_GJR_mat, 'COMFORT_MVG_DCC_GJR_VaR.csv')
writematrix(COMFORT_CVaR_DCC_GJR_mat, 'COMFORT_MVG_DCC_GJR_CVaR.csv')
